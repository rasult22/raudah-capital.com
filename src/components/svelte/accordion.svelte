...
let items = [
  ...
  },
  {
    ...
    isOpen: false,
    content: 'Фонд предоставляет финансирование до $1,000,000 для стартапов на стадиях pre-seed и seed, с инвестиционным периодом в 2 года. Средний чек для проектов с социальной значимостью составляет от $50,000 до $150,000.',
  },
  {
    id: 3,
    title: 'Какие критерия есть для заявки?',
    isOpen: false,
    content: 'Критерии для заявки в фонд WAQF: проекты должны приносить пользу мусульманскому сообществу и решать его актуальные проблемы, соответствуя при этом ценностям и принципам, важным для мусульман.',
  },
]
let prevId = 1
